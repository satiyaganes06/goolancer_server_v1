...
@section('admin_content')
    ...
    <div class="page-content">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
            <div>
                <h4 class="mb-3 mb-md-0">Service Approval</h4>
            </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($services as $service)
                                        ...
                                        <tr>
                                            <th class="">{{ $i }}</th>
                                            <td style="width: 150px" class="ellipse"> {{ $service->es_var_title }} </td>
                                            ...
                                            <td>
                                                @if ($service->es_int_status == 0)
                                                        <p class="text-warning">Pending</p>
                                                    @elseif ($service->es_int_status == 1)
                                            ...
                                            <td>
                                                <div class="d-flex ">
                                                    <a href="{{route('admin.viewServiceInfo', ['id' => $service->es_int_ref, 'from' => 1])}}"><i class="fs-6 " class="link-icon" data-feather="eye"
                                                            style="height: 20"></i></a>
